...
function Navbar() {
  ...
  const ref = useRef<HTMLDivElement>(null); // กำหนด type ให้กับ ref อย่างชัดเจน
        ...
        <div className="relative flex items-center justify-between h-16">
            ...
            <div className="hidden sm:block sm:ml-6">
              <div className="flex space-x-4">
                ...
                <NavLink
                  to="/"
                  className={({ isActive }) =>
                    `text-white hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium ${isActive ? 'bg-green-500' : ''
                    }`
                  }
                >
                  หน้าหลัก
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
              <NavLink to="/login" className="whitespace-nowrap text-sm font-medium text-gray-300 hover:text-white">
                Login
              </NavLink>
              <NavLink to="/register" className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-3 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-700 hover:bg-red-900">
                Register
              </NavLink>
            </div>
          ...
          <div className={`${isOpen ? 'sm:hidden block' : 'sm:hidden hidden'}`} id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <NavLink
                to="/"
                className={({ isActive }) =>
                  `text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium ${isActive ? 'bg-green-500' : ''
                  }`
                }
              >
                Home
